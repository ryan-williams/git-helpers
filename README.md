# git-helpers
[1,896](#count-completions) Git aliases and scripts.
...
# 1896 completions added by installing git-helpers
# By length:
# - 2 chars: 22
# - 3 chars: 278
# - 4 chars: 742
...
gdnxc      = g diff --no-ext-diff --cached
gdoth      = g diff-oth
...
ghosv      = github_open_settings_variables_actions
...
grbsc      = g rebase-shelve-continue
grbsh      = g rebase-shelve
grbsu      = g rebase-unshelve
...
ghosva     = github_open_settings_variables_actions
ghprcr     = ghpr create
...
1896 completions added by installing git-helpers (0 removed, 3531 total)
```
</details>
